...
module.exports = {
    name: "letter-league",
    aliases: ["letterleague", "lettertile", "letter-tile"],
    description: "Starts a new Letter League game activity in a voice channel.",
        ...
        serverConfig.findOne({ guildId: message.guild.id }, async (err, data) => {
            ...
            fetch(`https://discord.com/api/v9/channels/${channel.id}/invites`, {
                ...
                .then(async (invite) => {
                    if (!invite.code) {
                        try {
                            return await message.reply("Sadly I was unable to start a Letter League activity.")
                        } catch (e) {
                            console.log(e)
                        }
                    }
                    ...
                    try {
                        const e = new MessageEmbed()
                            ...
                            .setTitle(`Letter League!`)
                            .setDescription(`**Click the button below to play Letter League!**`)
