...
module.exports = {
    ...
    aliases: ["chess", "chessinthepark"],
    description: "Starts a new Chess In The Park game activity in a voice channel.",
        ...
        serverConfig.findOne({ guildId: message.guild.id }, async (err, data) => {
            ...
            fetch(`https://discord.com/api/v9/channels/${channel.id}/invites`, {
                ...
                .then(async (invite) => {
                    if (!invite.code) {
                        try {
                            return await message.reply("Sadly I was unable to start a Chess In The Park activity.")
                        } catch (e) {
                            console.log(e)
                        }
                    }
                    ...
                    try {
                        const e = new MessageEmbed()
                            ...
                            .setDescription(`**Click the button below to play Chess In The Park!**`)
