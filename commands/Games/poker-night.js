...
module.exports = {
    name: "poker-night",
    aliases: ["poker-party", "poker-night-party", "poker-night-party"],
    description: "Starts a new Poker Night game activity in a voice channel.",
        ...
        serverConfig.findOne({ guildId: message.guild.id }, async (err, data) => {
            ...
            fetch(`https://discord.com/api/v9/channels/${channel.id}/invites`, {
                ...
                .then(async (invite) => {
                    if (!invite.code) {
                        try {
                            return await message.reply("Sadly I was unable to start a Poker Night activity.")
                        } catch (e) {
                            console.log(e)
                        }
                    }
                    ...
                    try {
                        const e = new MessageEmbed()
                            ...
                            .setDescription(`**Click the button below to play Poker Night!**`)
